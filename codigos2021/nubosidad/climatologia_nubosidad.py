...
for i in range(0, len(data_list)):
    ...
    bajas_array = xr.DataArray(data=np.reshape(sum(cldamt_types[:6]), (1, cldamt_types.shape[1], cldamt_types.shape[2])), dims=["time", "lat", "lon"]).assign_coords({"lon": data_list[i].lon.values, "lat": data_list[i].lat.values, "time": data_list[i].time.values})
...
#%% Hago diferencia de medias de un periodo a otro: funcion
def diferencia_medias(media1,media2, data_list,variable, unidad, anual_mensual_estacion):
    # cargo lats y lons para armar xarray
    lats = data_list[0].coords["lat"].values
    lons = data_list[0].coords["lon"].values
    coords = [("lat", lats), ("lon", lons)]

    xarray_diferencia_medias= xr.DataArray(media2.values-media1.values, coords=coords)
    xarray_diferencia_medias.name = variable + " diferencia media " + anual_mensual_estacion
    xarray_diferencia_medias.attrs['units'] = unidad
    
    return xarray_diferencia_medias
...
#%% Hago diferencia de medias de un periodo a otro: corro funcion

# defino lista con meses y con trimestres
meses_numero = ["01", "02", "03", "04", "05", "06","07", "08", "09", "10", "11", "12"]
meses_palabra=["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre"]
meses=list(zip(meses_numero, meses_palabra))

trimestres_numero = [("12", "01", "02"),("03", "04", "05"), ("06", "07", "08"),("09", "10", "11")]
trimestres_palabra =["12-01-02","03-04-05","06-07-08","09-10-11"]
trimestres=list(zip(trimestres_numero, trimestres_palabra))

#cldamt
#cldamt anual
media_anual_cldamt_periodo1 = media_desvio(data_list[6:198], "cldamt", None, "%", False)[0] #En1984-Dic1999
media_anual_cldamt_periodo2 = media_desvio(data_list[198:402], "cldamt", None, "%", False)[0] #En2000-Dic2016
diferencia_media_anual_cldamt_1984_2000_2000_2016=diferencia_medias(media_anual_cldamt_periodo1, media_anual_cldamt_periodo2, data_list,"cldamt", "%", "anual")

#cldmt mensual
diferencia_media_mensual_cldamt_1984_2000_2000_2016_list = []
for mes in meses:
    media1=media_desvio(data_list[6:198], "cldamt", mes[0], "%", False)[0] #En1984-Dic1999
    media2=media_desvio(data_list[198:402], "cldamt", mes[0], "%", False)[0] #En2000-Dic2016
    diferencia_media_mensual_cldamt_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt","%",mes[0]))

#cldmt trimestral
diferencia_media_trimestral_cldamt_1984_2000_2000_2016_list = []
for trimestre in trimestres:
    media1=media_desvio(data_list[5:197], "cldamt", trimestre[0], "%", False)[0] #Dic1983-Nov1999
    media2=media_desvio(data_list[197:401], "cldamt", trimestre[0], "%", False)[0] #Nov1999-Nov2016
    diferencia_media_trimestral_cldamt_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt","%",trimestre[1]))

#cldamt_bajas
#cldamt_bajas anual
media_anual_cldamt_bajas_periodo1 = media_desvio(data_list[6:198], "cldamt_bajas", None, "%", False)[0] #En1984-Dic1999
media_anual_cldamt_bajas_periodo2 = media_desvio(data_list[198:402], "cldamt_bajas", None, "%", False)[0] #En2000-Dic2016
diferencia_media_anual_cldamt_bajas_1984_2000_2000_2016=diferencia_medias(media_anual_cldamt_bajas_periodo1, media_anual_cldamt_bajas_periodo2, data_list,"cldamt_bajas", "%", "anual")

#cldmt_bajas mensual
diferencia_media_mensual_cldamt_bajas_1984_2000_2000_2016_list = []
for mes in meses:
    media1=media_desvio(data_list[6:198], "cldamt_bajas", mes[0], "%", False)[0]
    media2=media_desvio(data_list[198:402], "cldamt_bajas", mes[0], "%", False)[0]
    diferencia_media_mensual_cldamt_bajas_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt_bajas","%",mes[0]))

#cldmt_bajas trimestral
diferencia_media_trimestral_cldamt_bajas_1984_2000_2000_2016_list = []
for trimestre in trimestres:
    media1=media_desvio(data_list[5:197], "cldamt_bajas", trimestre[0], "%", False)[0]
    media2=media_desvio(data_list[197:401], "cldamt_bajas", trimestre[0], "%", False)[0]
    diferencia_media_trimestral_cldamt_bajas_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt_bajas","%",trimestre[1]))

#cldamt_medias
#cldamt_medias anual
media_anual_cldamt_medias_periodo1 = media_desvio(data_list[6:198], "cldamt_medias", None, "%", False)[0] #En1984-Dic1999
media_anual_cldamt_medias_periodo2 = media_desvio(data_list[198:402], "cldamt_medias", None, "%", False)[0] #En2000-Dic2016
diferencia_media_anual_cldamt_medias_1984_2000_2000_2016=diferencia_medias(media_anual_cldamt_medias_periodo1, media_anual_cldamt_medias_periodo2, data_list,"cldamt_medias", "%", "anual")

#cldmt_medias mensual
diferencia_media_mensual_cldamt_medias_1984_2000_2000_2016_list = []
for mes in meses:
    media1=media_desvio(data_list[6:198], "cldamt_medias", mes[0], "%", False)[0]
    media2=media_desvio(data_list[198:402], "cldamt_medias", mes[0], "%", False)[0]
    diferencia_media_mensual_cldamt_medias_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt_medias","%",mes[0]))

#cldmt_medias trimestral
diferencia_media_trimestral_cldamt_medias_1984_2000_2000_2016_list = []
for trimestre in trimestres:
    media1=media_desvio(data_list[5:197], "cldamt_medias", trimestre[0], "%", False)[0]
    media2=media_desvio(data_list[197:401], "cldamt_medias", trimestre[0], "%", False)[0]
    diferencia_media_trimestral_cldamt_medias_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt_medias","%",trimestre[1]))

#cldamt_altas
#cldamt_altas anual
media_anual_cldamt_altas_periodo1 = media_desvio(data_list[6:198], "cldamt_altas", None, "%", False)[0] #En1984-Dic1999
media_anual_cldamt_altas_periodo2 = media_desvio(data_list[198:402], "cldamt_altas", None, "%", False)[0] #En2000-Dic2016
diferencia_media_anual_cldamt_altas_1984_2000_2000_2016=diferencia_medias(media_anual_cldamt_altas_periodo1, media_anual_cldamt_altas_periodo2, data_list,"cldamt_altas", "%", "anual")

#cldmt_altas mensual
diferencia_media_mensual_cldamt_altas_1984_2000_2000_2016_list = []
for mes in meses:
    media1=media_desvio(data_list[6:198], "cldamt_altas", mes[0], "%", False)[0]
    media2=media_desvio(data_list[198:402], "cldamt_altas", mes[0], "%", False)[0]
    diferencia_media_mensual_cldamt_altas_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt_altas","%",mes[0]))

#cldmt_altas trimestral
diferencia_media_trimestral_cldamt_altas_1984_2000_2000_2016_list = []
for trimestre in trimestres:
    media1=media_desvio(data_list[5:197], "cldamt_altas", trimestre[0], "%", False)[0]
    media2=media_desvio(data_list[197:401], "cldamt_altas", trimestre[0], "%", False)[0]
    diferencia_media_trimestral_cldamt_altas_1984_2000_2000_2016_list.append(diferencia_medias(media1,media2, data_list, "cldamt_altas","%",trimestre[1]))
...
def grafico_campos_climatologia_nubosidad(paises, provincias, data_list_climatologia, indice_list, variable, climatologia_tipo, lat_min, lat_max, lon_min, lon_max, unidades_nombre, valor_minimo, valor_maximo, delta_valor, xticks_min, xticks_max, yticks_min, yticks_max, grid, region, ruta_salida, paleta_color, espacio_entre_lat_lon, orientacion):
    ...
    # selecciona variable
    if (climatologia_tipo == "anual"):
        variable_data = data_list_climatologia
...
#%% diferencia de medias: corro graficos
# ploteo para sudamerica

meses = ["01", "02", "03", "03", "03", "03", "03", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"]
estaciones = ["12-01-02", "03-04-05", "06-07-08", "09-10-11"]

grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_anual_cldamt_1984_2000_2000_2016, 0, "diferencia cldamt media (1984-2000 2000-2016)", "anual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_climatologia", "balance", 8, "V")

for i in range(0, 12):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_mensual_cldamt_1984_2000_2000_2016_list, i, "diferencia cldamt media mensual (1984-2000 2000-2016)", "mensual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_climatologia", "balance", 8, "V")

for i in range(0, 4):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_trimestral_cldamt_1984_2000_2000_2016_list, i, "diferencia cldamt media trimestral (1984-2000 2000-2016)", "trimestral", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_climatologia", "balance", 8, "V")

plt.close(fig="all")
#bajas
grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_anual_cldamt_bajas_1984_2000_2000_2016, 0, "diferencia cldamt_bajas media (1984-2000 2000-2016)", "anual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_bajas_climatologia", "balance", 8, "V")

for i in range(0, 12):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_mensual_cldamt_bajas_1984_2000_2000_2016_list, i, "diferencia cldamt_bajas media mensual (1984-2000 2000-2016)", "mensual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_bajas_climatologia", "balance", 8, "V")

for i in range(0, 4):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_trimestral_cldamt_bajas_1984_2000_2000_2016_list, i, "diferencia cldamt_bajas media trimestral (1984-2000 2000-2016)", "trimestral", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_bajas_climatologia", "balance", 8, "V")

plt.close(fig="all")
#medias
grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_anual_cldamt_medias_1984_2000_2000_2016, 0, "diferencia cldamt_medias media (1984-2000 2000-2016)", "anual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_medias_climatologia", "balance", 8, "V")

for i in range(0, 12):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_mensual_cldamt_medias_1984_2000_2000_2016_list, i, "diferencia cldamt_medias media mensual (1984-2000 2000-2016)", "mensual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_medias_climatologia", "balance", 8, "V")

for i in range(0, 4):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_trimestral_cldamt_medias_1984_2000_2000_2016_list, i, "diferencia cldamt_medias media trimestral (1984-2000 2000-2016)", "trimestral", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_medias_climatologia", "balance", 8, "V")

plt.close(fig="all")
#bajas
grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_anual_cldamt_altas_1984_2000_2000_2016, 0, "diferencia cldamt_altas media (1984-2000 2000-2016)", "anual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_altas_climatologia", "balance", 8, "V")

for i in range(0, 12):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_mensual_cldamt_altas_1984_2000_2000_2016_list, i, "diferencia cldamt_altas media mensual (1984-2000 2000-2016)", "mensual", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_altas_climatologia", "balance", 8, "V")

for i in range(0, 4):
    grafico_campos_climatologia_nubosidad(paises, provincias, diferencia_media_trimestral_cldamt_altas_1984_2000_2000_2016_list, i, "diferencia cldamt_altas media trimestral (1984-2000 2000-2016)", "trimestral", -60, 15, -90, -30, "%",-20, 22, 2, -85, -30, -55, 15, True, "Sudamérica", "../../../resultados/resultados2021/nubosidad/cldamt_altas_climatologia", "balance", 8, "V")
